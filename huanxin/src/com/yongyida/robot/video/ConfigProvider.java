...
public class ConfigProvider extends ContentProvider {
	...
	public static boolean exists(String name) {
		Cursor cursor = RobotApplication.getInstance().getContentResolver().query(ConfigProvider.CONTENT_URI, null,
	...
	public static void insert(String name, String value) {
		...
		try {
			Uri row = RobotApplication.getInstance().getContentResolver().insert(ConfigProvider.CONTENT_URI,
					values);
			if (row == null)
	...
	public static int update(String name, String value) {
		ContentValues values = new ContentValues();
		values.put(VLAUE_COL, value);
		return RobotApplication.getInstance().getContentResolver().update(ConfigProvider.CONTENT_URI, values,
