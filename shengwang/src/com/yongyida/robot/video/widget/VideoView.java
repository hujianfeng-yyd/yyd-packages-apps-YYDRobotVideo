 ...
 * 
 */
public class VideoView extends LinearLayout implements ISwitchView {
	private Context mContext;
	private String mViewKey;
	private LinearLayout mLinearLayout;
	private FrameLayout mSurfaceContainer;
	private TextView mTvTitle;
	private ViewStyle mViewStyle = ViewStyle.FullView;
	...
	public VideoView(Context context, String viewKey) {
		super(context);
		mContext = context;
		mViewKey = viewKey;
		init();
	...
	public SurfaceView getSurfaceView() {
		if (mSurfaceContainer != null
				&& mSurfaceContainer.getChildCount() > 0) {
	...
	public void setSurfaceView(SurfaceView view) {
		mSurfaceContainer.addView(view, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, 1.0f));
	}
	...
	private void init() {
		...
		mLinearLayout = (LinearLayout)inflater.inflate(R.layout.widget_video_view, (ViewGroup)getParent());
		mLinearLayout.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, 1.0f));
