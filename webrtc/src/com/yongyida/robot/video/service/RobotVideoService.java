...
import com.yongyida.robot.video.WebRtcVideoListener;
...
public class RobotVideoService extends Service {
	...
	public void onCreate() {
		...
		mVideoListener = new WebRtcVideoListener(getApplicationContext());
		mVideoListener.open();
	...
	private void improvePriority() {
		...
		PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, RobotVideoService.class), 0);
