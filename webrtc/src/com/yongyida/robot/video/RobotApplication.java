...
public class RobotApplication extends Application {
	...
	public void onCreate() {
		...
		// 视频SDK初始化
		YYDVideoServer.getInstance().init(mContext);
		WebRtcSDKHelper.getInstance().init(mContext);
	 ...
	 * 查询机器人是否处于视频状态
	 * 
	 * @return true, 正在视频中 false, 非 视频中
	 * 
	 */
	public boolean isVideoing() {
		String value = null;
		Cursor cursor = mContext.getContentResolver().query(ConfigProvider.CONTENT_URI, null, "name = ?",
				new String[] { "videoing" }, null);
		try {
