...
import com.yongyida.robot.video.apprtc.util.AppRTCUtils;
...
public class AppRTCBluetoothManager {
	...
	private class BluetoothServiceListener implements BluetoothProfile.ServiceListener {
		...
		@Override
		/**
		 * Notifies the client when the proxy object has been disconnected from
		 * the service.
		 */
	 ...
	 * if/when the BT headset is enabled. Example of state change sequence when
	 * start() is called while BT device is connected and enabled: UNINITIALIZED
	 ...
	 * application always has the priority on the usage of the SCO connection
	 * for telephony. If this method is called while the phone is in call it
	 * will be ignored. Similarly, if a call is received or sent while an
	 * application is using the SCO connection, the connection will be lost for
	 * the application and NOT returned automatically when the call ends. Also
	 * note that: up to and including API version JELLY_BEAN_MR1, this method
	 ...
	 * also for JBMR2 and higher. It might be required to initiates a virtual
	 * voice call since many devices do not accept SCO audio without a "call".
	 */
	...
	/**
	 * Ensures that the audio manager updates its list of available audio
	 * devices.
	 */
