...
public class HudFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		videoCodec = sharedPref.getString(getString(R.string.pref_videocodec_key), getString(R.string.pref_videocodec_default));
		videoSize = sharedPref.getString(getString(R.string.pref_resolution_key), getString(R.string.pref_resolution_default));
	...
	public void updateEncoderStatistics(final StatsReport[] reports) {
		...
		encoderStat.append("Video:  ").append(videoCodec).append("\n");
		encoderStat.append("Video Size:  ").append(videoSize).append("\n");
		if (videoCallEnabled) {
			if (fps != null) {
		...
		if (cpuMonitor != null) {
			encoderStat.append("CPU%: ").append(cpuMonitor.getCpuUsageCurrent()).append("/")
					.append(cpuMonitor.getCpuUsageAverage()).append(". Freq: ")
