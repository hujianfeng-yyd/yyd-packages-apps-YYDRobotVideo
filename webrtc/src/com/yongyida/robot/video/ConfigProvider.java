...
public class ConfigProvider extends ContentProvider {
	...
	public static boolean exists(String name) {
		Cursor cursor = RobotApplication.getInstance().getContext().getContentResolver()
				.query(ConfigProvider.CONTENT_URI, null, NAME_COL + "=?", new String[] { name }, null);
	...
	public static void insert(String name, String value) {
		...
		try {
			Uri row = RobotApplication.getInstance().getContext().getContentResolver()
					.insert(ConfigProvider.CONTENT_URI, values);
			if (row == null)
	...
	public static int update(String name, String value) {
		ContentValues values = new ContentValues();
		values.put(VLAUE_COL, value);
		return RobotApplication.getInstance().getContext().getContentResolver().update(ConfigProvider.CONTENT_URI,
				values, NAME_COL + "=?", new String[] { name });
	}
